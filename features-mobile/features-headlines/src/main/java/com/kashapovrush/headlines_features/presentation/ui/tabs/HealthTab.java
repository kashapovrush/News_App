...
public class HealthTab extends MvpAppCompatFragment implements HeadlinesView{
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        presenter.loadHeadlines(EXTRA_HEALTH_TAB);
        binding.swipeRefresh.setOnRefreshListener(() -> {
            binding.swipeRefresh.setRefreshing(true);
            presenter.updateHeadlines(EXTRA_HEALTH_TAB);
    ...
    public static final String EXTRA_HEALTH_TAB = "health";
