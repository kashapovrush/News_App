...
public class EntertainmentTab extends MvpAppCompatFragment implements HeadlinesView {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        presenter.loadHeadlines(EXTRA_ENTERTAINMENT_TAB);
        binding.swipeRefresh.setOnRefreshListener(() -> {
            binding.swipeRefresh.setRefreshing(true);
            presenter.updateHeadlines(EXTRA_ENTERTAINMENT_TAB);
    ...
    public static final String EXTRA_ENTERTAINMENT_TAB = "entertainment";

    public static EntertainmentTab newInstance() {
