...
public class GeneralTab extends MvpAppCompatFragment implements HeadlinesView {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        presenter.loadHeadlines(EXTRA_GENERAL_TAB);

        binding.swipeRefresh.setOnRefreshListener(() -> {
            binding.swipeRefresh.setRefreshing(true);
            presenter.updateHeadlines(EXTRA_GENERAL_TAB);
    ...
    public void showError(String error) {
        binding.progressBarGeneral.setVisibility(View.INVISIBLE);
        ((ClickListenerFromHeadlines) requireActivity()).clickListenerToShowError(error);
    }

    public interface ClickListenerFromHeadlines {
        void clickListenerToShowError(String error);
    }

    public static final String EXTRA_GENERAL_TAB = "general";

    public static GeneralTab newInstance() {
