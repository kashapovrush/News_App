...
public class TechnologyTab extends MvpAppCompatFragment implements HeadlinesView{
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        presenter.loadHeadlines(EXTRA_TECHNOLOGY_TAB);
        binding.swipeRefresh.setOnRefreshListener(() -> {
            binding.swipeRefresh.setRefreshing(true);
            presenter.updateHeadlines(EXTRA_TECHNOLOGY_TAB);
    ...
    public static final String EXTRA_TECHNOLOGY_TAB = "technology";

    public static TechnologyTab newInstance() {
