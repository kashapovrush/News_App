...
public class ScienceTab extends MvpAppCompatFragment implements HeadlinesView{
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        presenter.loadHeadlines(EXTRA_SCIENCE_TAB);
        binding.swipeRefresh.setOnRefreshListener(() -> {
            binding.swipeRefresh.setRefreshing(true);
            presenter.updateHeadlines(EXTRA_SCIENCE_TAB);
    ...
    public static final String EXTRA_SCIENCE_TAB = "science";

    public static ScienceTab newInstance() {
