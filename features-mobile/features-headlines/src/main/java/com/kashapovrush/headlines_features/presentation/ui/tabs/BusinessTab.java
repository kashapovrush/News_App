...
public class BusinessTab extends MvpAppCompatFragment implements HeadlinesView {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        presenter.loadHeadlines(EXTRA_BUSINESS_TAB);
        binding.swipeRefresh.setOnRefreshListener(() -> {
            binding.swipeRefresh.setRefreshing(true);
            presenter.updateHeadlines(EXTRA_BUSINESS_TAB);
    ...
    public interface ClickListener {
        ...
        void clickListenerFromTabs(NewsHeadlines post);
    }

    public static final String EXTRA_BUSINESS_TAB = "business";

    public static BusinessTab newInstance() {
